/* global Power1, createjs, nodecg, TimelineLite, TweenLite */
(function () {
	'use strict';
	...
	class NcgMediaPlayer extends Polymer.MutableData(Polymer.Element) {
		static get is() {
			return 'ncg-media-player';
		}
	...
	customElements.define(NcgMediaPlayer.is, NcgMediaPlayer);
