...
module.exports.start = function () {
	...
	app.get('/media.html', ncgUtils.authCheck, (req, res) => {
		const mediaHtmlPath = path.join(config.developer ? SRC_PATH : BUILD_PATH, 'media.html');
		ncgUtils.injectScripts(mediaHtmlPath, 'graphic', {
